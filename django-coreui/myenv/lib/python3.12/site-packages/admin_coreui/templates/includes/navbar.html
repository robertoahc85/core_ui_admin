...
<div class="container-fluid border-bottom px-4">
    <button class="header-toggler" type="button" onclick="coreui.Sidebar.getInstance(document.querySelector('#sidebar')).toggle()" style="margin-inline-start: -14px;">
      <svg class="icon icon-lg" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <title>menu</title>
    ...
    <ul class="header-nav d-none d-lg-flex">
      <li class="nav-item"><a class="nav-link" href="#">Tablero</a></li>
    ...
    <ul class="header-nav ms-auto">
      ...
      <li class="nav-item"><a class="nav-link" href="#">
        ...
        <svg version="1.1"  class="icon icon-lg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      ...
      <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu dropdown-menu-end pt-0">
          ...
          <a class="dropdown-item" href="#">
            ...
            <svg class="icon me-2" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <title>bell</title>
              <path d="M21.106 16.339l-2.047-3.779v-3.935c0-3.929-3.196-7.125-7.125-7.125s-7.125 3.196-7.125 7.125v3.935l-2.047 3.779c-0.085 0.155-0.136 0.339-0.136 0.536 0 0.621 0.504 1.125 1.125 1.125h4.075c-0.011 0.124-0.017 0.249-0.017 0.375 0 2.278 1.847 4.125 4.125 4.125s4.125-1.847 4.125-4.125v0c0-0.126-0.006-0.251-0.017-0.375h4.075c0 0 0 0 0 0 0.621 0 1.125-0.504 1.125-1.125 0-0.196-0.050-0.381-0.139-0.542l0.003 0.006zM14.559 18.375c0 0.001 0 0.001 0 0.002 0 1.45-1.175 2.625-2.625 2.625s-2.625-1.175-2.625-2.625c0-0.133 0.010-0.264 0.029-0.392l-0.002 0.014h5.196c0.017 0.113 0.027 0.243 0.027 0.375v0zM4.381 16.5l1.928-3.56v-4.315c0-3.107 2.518-5.625 5.625-5.625s5.625 2.518 5.625 5.625v0 4.315l1.928 3.56z"></path>
              </svg>
            Updates
            ...
            <a class="dropdown-item" href="#">
             ...
             Messages
             <span class="badge badge-sm bg-success ms-2">42</span></a>
             <a class="dropdown-item" href="#">
            <svg class="icon me-2" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <title>task</title>
            ...
            Tasks
            <span class="badge badge-sm bg-danger ms-2">42</span></a>
          ...
          <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold my-2">
            <div class="fw-semibold">Configuracion</div>
          </div>
          <a class="dropdown-item" href="#">
            ...
            <a class="dropdown-item" href="#">
             ...
             Hola
             <span class="badge badge-sm bg-secondary ms-2">42</span></a>
          ...
          <div class="dropdown-divider"></div>
           ...
           Bloquear cuentas
            ...
            {% if user.is_authenticated %}
            <a class="dropdown-item" href="{% if request.user.is_superuser %} {% url 'admin:logout' %} {% else %} {% url 'logout' %} {% endif %}">
                <svg class="icon me-2" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
